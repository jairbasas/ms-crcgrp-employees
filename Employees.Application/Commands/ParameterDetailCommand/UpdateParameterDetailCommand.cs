...
namespace Employees.Application.Commands.ParameterDetailCommand
{
    public class UpdateParameterDetailCommand : IRequest<Response<int>>
    {
    ...
    public class UpdateParameterDetailCommandHandler : IRequestHandler<UpdateParameterDetailCommand, Response<int>>
    {
        readonly IParameterDetailRepository _iParameterDetailRepository;

        readonly IValuesSettings _iValuesSettings;

        public UpdateParameterDetailCommandHandler(IParameterDetailRepository iParameterDetailRepository, IValuesSettings iValuesSettings)
        {
            _iParameterDetailRepository = iParameterDetailRepository;
            _iValuesSettings = iValuesSettings;
        }

        public async Task<Response<int>> Handle(UpdateParameterDetailCommand request, CancellationToken cancellationToken)
        {
